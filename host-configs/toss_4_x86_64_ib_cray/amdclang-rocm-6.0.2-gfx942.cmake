...
set(CMAKE_CXX_FLAGS "-std=c++14 --cuda-gpu-arch=gfx942" CACHE STRING "")
...
set(MPI_CXX_COMPILER "/usr/tce/packages/cray-mpich-tce/cray-mpich-8.1.24-rocmcc-6.0.2/bin/mpicxx" CACHE PATH "")
set(MPI_CXX_LINK_FLAGS "-Wl,-rpath,/opt/cray/pe/mpich/8.1.24/ofi/amd/5.0/lib -Wl,-rpath,/opt/cray/libfabric/2.0/lib64:/opt/cray/pe/pmi/6.1.9/lib:/opt/cray/pe/pals/1.2.9/lib:/opt/cray/pe/cce/15.0.1/cce/x86_64/lib:/opt/rocm-6.0.2/llvm/lib")

set(HIP_HIPCC_FLAGS "-D__HIP_ROCclr__ -D__HIP_PLATFORM_AMD__ -DCAMP_USE_PLATFORM_DEFAULT_STREAM -std=c++14 -x hip --gpu-arch=gfx942" CACHE STRING "")
