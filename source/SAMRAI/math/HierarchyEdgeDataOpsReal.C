...
template<class TYPE>
void
HierarchyEdgeDataOpsReal<TYPE>::setPatchHierarchy(
   const std::shared_ptr<hier::PatchHierarchy>& hierarchy)
{
   TBOX_ASSERT(hierarchy);
...
template<class TYPE>
void
HierarchyEdgeDataOpsReal<TYPE>::resetLevels(
   const int coarsest_level,
   const int finest_level)
{
...
template<class TYPE>
void
HierarchyEdgeDataOpsReal<TYPE>::copyData(
   const int dst_id,
   const int src_id,
...
template<class TYPE>
void
HierarchyEdgeDataOpsReal<TYPE>::swapData(
   const int data1_id,
   const int data2_id) const
{
#ifdef DEBUG_CHECK_ASSERTIONS
   std::shared_ptr<pdat::EdgeDataFactory<TYPE> > d1fact(
      SAMRAI_SHARED_PTR_CAST<pdat::EdgeDataFactory<TYPE>, hier::PatchDataFactory>(
         d_hierarchy->getPatchDescriptor()->getPatchDataFactory(data1_id)));
   TBOX_ASSERT(d1fact);
   std::shared_ptr<pdat::EdgeDataFactory<TYPE> > d2fact(
      SAMRAI_SHARED_PTR_CAST<pdat::EdgeDataFactory<TYPE>, hier::PatchDataFactory>(
...
template<class TYPE>
void
HierarchyEdgeDataOpsReal<TYPE>::printData(
   const int data_id,
   std::ostream& s,
   const bool interior_only) const
{
   ...
   for (int ln = d_coarsest_level; ln <= d_finest_level; ++ln) {
      ...
      for (hier::PatchLevel::iterator ip(level->begin());
         ...
         std::shared_ptr<pdat::EdgeData<TYPE> > d(
            SAMRAI_SHARED_PTR_CAST<pdat::EdgeData<TYPE>, hier::PatchData>(
...
template<class TYPE>
void
HierarchyEdgeDataOpsReal<TYPE>::setToScalar(
   const int data_id,
   const TYPE& alpha,
   const bool interior_only) const
{
...
template<class TYPE>
void
HierarchyEdgeDataOpsReal<TYPE>::scale(
   const int dst_id,
   const TYPE& alpha,
   const int src_id,
   const bool interior_only) const
...
template<class TYPE>
void
HierarchyEdgeDataOpsReal<TYPE>::addScalar(
   const int dst_id,
   const int src_id,
   const TYPE& alpha,
   const bool interior_only) const
...
template<class TYPE>
void
HierarchyEdgeDataOpsReal<TYPE>::add(
   const int dst_id,
   const int src1_id,
   const int src2_id,
   const bool interior_only) const
   ...
   for (int ln = d_coarsest_level; ln <= d_finest_level; ++ln) {
      ...
      for (hier::PatchLevel::iterator ip(level->begin());
         ...
         std::shared_ptr<pdat::EdgeData<TYPE> > dst(
            SAMRAI_SHARED_PTR_CAST<pdat::EdgeData<TYPE>, hier::PatchData>(
               p->getPatchData(dst_id)));
         std::shared_ptr<pdat::EdgeData<TYPE> > src1(
            SAMRAI_SHARED_PTR_CAST<pdat::EdgeData<TYPE>, hier::PatchData>(
               p->getPatchData(src1_id)));
         std::shared_ptr<pdat::EdgeData<TYPE> > src2(
            SAMRAI_SHARED_PTR_CAST<pdat::EdgeData<TYPE>, hier::PatchData>(
...
template<class TYPE>
void
HierarchyEdgeDataOpsReal<TYPE>::subtract(
   const int dst_id,
   const int src1_id,
   const int src2_id,
   const bool interior_only) const
...
template<class TYPE>
void
HierarchyEdgeDataOpsReal<TYPE>::multiply(
   const int dst_id,
   const int src1_id,
   const int src2_id,
   const bool interior_only) const
...
template<class TYPE>
void
HierarchyEdgeDataOpsReal<TYPE>::divide(
   const int dst_id,
   const int src1_id,
   const int src2_id,
   const bool interior_only) const
...
template<class TYPE>
void
HierarchyEdgeDataOpsReal<TYPE>::reciprocal(
   const int dst_id,
   const int src_id,
   const bool interior_only) const
{
...
template<class TYPE>
void
HierarchyEdgeDataOpsReal<TYPE>::linearSum(
   const int dst_id,
   const TYPE& alpha,
   const int src1_id,
   const TYPE& beta,
...
template<class TYPE>
void
HierarchyEdgeDataOpsReal<TYPE>::axpy(
   const int dst_id,
   const TYPE& alpha,
   const int src1_id,
   const int src2_id,
...
template<class TYPE>
void
HierarchyEdgeDataOpsReal<TYPE>::axmy(
   const int dst_id,
   const TYPE& alpha,
   const int src1_id,
   const int src2_id,
...
template<class TYPE>
void
HierarchyEdgeDataOpsReal<TYPE>::abs(
   const int dst_id,
   const int src_id,
   const bool interior_only) const
{
...
template<class TYPE>
void
HierarchyEdgeDataOpsReal<TYPE>::setRandomValues(
   const int data_id,
   const TYPE& width,
   const TYPE& low,
   const bool interior_only) const
...
template<class TYPE>
size_t
HierarchyEdgeDataOpsReal<TYPE>::numberOfEntries(
   const int data_id,
   const bool interior_only) const
{
   TBOX_ASSERT(d_hierarchy);
   ...
   if (interior_only) {
      ...
      std::shared_ptr<pdat::EdgeDataFactory<TYPE> > dfact(
         SAMRAI_SHARED_PTR_CAST<pdat::EdgeDataFactory<TYPE>, hier::PatchDataFactory>(
...
template<class TYPE>
double
HierarchyEdgeDataOpsReal<TYPE>::sumControlVolumes(
   const int data_id,
   ...
   for (int ln = d_coarsest_level; ln <= d_finest_level; ++ln) {
      ...
      for (hier::PatchLevel::iterator ip(level->begin());
         ...
         std::shared_ptr<pdat::EdgeData<TYPE> > data(
            SAMRAI_SHARED_PTR_CAST<pdat::EdgeData<TYPE>, hier::PatchData>(
               p->getPatchData(data_id)));
         std::shared_ptr<pdat::EdgeData<double> > cv(
...
template<class TYPE>
double
HierarchyEdgeDataOpsReal<TYPE>::L1Norm(
   const int data_id,
   const int vol_id,
   bool local_only) const
{
   ...
   for (int ln = d_coarsest_level; ln <= d_finest_level; ++ln) {
      ...
      for (hier::PatchLevel::iterator ip(level->begin());
         ...
         std::shared_ptr<pdat::EdgeData<double> > cv(
            std::dynamic_pointer_cast<pdat::EdgeData<double>,
                                        hier::PatchData>(pd));
...
template<class TYPE>
double
HierarchyEdgeDataOpsReal<TYPE>::L2Norm(
   const int data_id,
   const int vol_id,
   bool local_only) const
{
...
template<class TYPE>
double
HierarchyEdgeDataOpsReal<TYPE>::weightedL2Norm(
   const int data_id,
   const int wgt_id,
   const int vol_id) const
{
   ...
   for (int ln = d_coarsest_level; ln <= d_finest_level; ++ln) {
      ...
      for (hier::PatchLevel::iterator ip(level->begin());
         ...
         std::shared_ptr<pdat::EdgeData<TYPE> > data(
            SAMRAI_SHARED_PTR_CAST<pdat::EdgeData<TYPE>, hier::PatchData>(
               p->getPatchData(data_id)));
         std::shared_ptr<pdat::EdgeData<TYPE> > weight(
            SAMRAI_SHARED_PTR_CAST<pdat::EdgeData<TYPE>, hier::PatchData>(
...
template<class TYPE>
double
HierarchyEdgeDataOpsReal<TYPE>::RMSNorm(
   const int data_id,
   const int vol_id) const
{
...
template<class TYPE>
double
HierarchyEdgeDataOpsReal<TYPE>::weightedRMSNorm(
   const int data_id,
   const int wgt_id,
   const int vol_id) const
{
...
template<class TYPE>
double
HierarchyEdgeDataOpsReal<TYPE>::maxNorm(
   const int data_id,
   const int vol_id,
   bool local_only) const
{
...
template<class TYPE>
TYPE
HierarchyEdgeDataOpsReal<TYPE>::dot(
   const int data1_id,
   const int data2_id,
   const int vol_id,
   bool local_only) const
{
   ...
   for (int ln = d_coarsest_level; ln <= d_finest_level; ++ln) {
      ...
      for (hier::PatchLevel::iterator ip(level->begin());
         ...
         std::shared_ptr<pdat::EdgeData<TYPE> > data1(
            SAMRAI_SHARED_PTR_CAST<pdat::EdgeData<TYPE>, hier::PatchData>(
               p->getPatchData(data1_id)));
         std::shared_ptr<pdat::EdgeData<TYPE> > data2(
            SAMRAI_SHARED_PTR_CAST<pdat::EdgeData<TYPE>, hier::PatchData>(
...
template<class TYPE>
TYPE
HierarchyEdgeDataOpsReal<TYPE>::integral(
   const int data_id,
   const int vol_id) const
{
   TBOX_ASSERT(d_hierarchy);
   ...
   for (int ln = d_coarsest_level; ln <= d_finest_level; ++ln) {
      ...
      for (hier::PatchLevel::iterator ip(level->begin());
         ...
         std::shared_ptr<pdat::EdgeData<TYPE> > data(
            SAMRAI_SHARED_PTR_CAST<pdat::EdgeData<TYPE>, hier::PatchData>(
               p->getPatchData(data_id)));
         std::shared_ptr<pdat::EdgeData<double> > vol(
            SAMRAI_SHARED_PTR_CAST<pdat::EdgeData<double>, hier::PatchData>(
               p->getPatchData(vol_id)));
...
template<class TYPE>
int
HierarchyEdgeDataOpsReal<TYPE>::computeConstrProdPos(
   const int data1_id,
   const int data2_id,
   const int vol_id) const
{
...
template<class TYPE>
void
HierarchyEdgeDataOpsReal<TYPE>::compareToScalar(
   const int dst_id,
   const int src_id,
   const TYPE& alpha,
   const int vol_id) const
...
template<class TYPE>
int
HierarchyEdgeDataOpsReal<TYPE>::testReciprocal(
   const int dst_id,
   const int src_id,
   const int vol_id) const
{
...
template<class TYPE>
TYPE
HierarchyEdgeDataOpsReal<TYPE>::maxPointwiseDivide(
   const int numer_id,
   const int denom_id,
   bool local_only) const
{
   ...
   for (int ln = d_coarsest_level; ln <= d_finest_level; ++ln) {
      ...
      for (hier::PatchLevel::iterator ip(level->begin());
         ...
         std::shared_ptr<pdat::EdgeData<TYPE> > numer(
            SAMRAI_SHARED_PTR_CAST<pdat::EdgeData<TYPE>, hier::PatchData>(
               p->getPatchData(numer_id)));
         std::shared_ptr<pdat::EdgeData<TYPE> > denom(
            SAMRAI_SHARED_PTR_CAST<pdat::EdgeData<TYPE>, hier::PatchData>(
...
template<class TYPE>
TYPE
HierarchyEdgeDataOpsReal<TYPE>::minPointwiseDivide(
   const int numer_id,
   const int denom_id,
   bool local_only) const
{
...
template<class TYPE>
TYPE
HierarchyEdgeDataOpsReal<TYPE>::min(
   const int data_id,
   const bool interior_only) const
{
   TBOX_ASSERT(d_hierarchy);
...
template<class TYPE>
TYPE
HierarchyEdgeDataOpsReal<TYPE>::max(
   const int data_id,
   const bool interior_only) const
{
   TBOX_ASSERT(d_hierarchy);
