...
template<class TYPE>
void
HierarchyCellDataOpsReal<TYPE>::setPatchHierarchy(
   const std::shared_ptr<hier::PatchHierarchy>& hierarchy)
{
   TBOX_ASSERT(hierarchy);
...
template<class TYPE>
void
HierarchyCellDataOpsReal<TYPE>::resetLevels(
   const int coarsest_level,
   const int finest_level)
{
...
template<class TYPE>
void
HierarchyCellDataOpsReal<TYPE>::copyData(
   const int dst_id,
   const int src_id,
...
template<class TYPE>
void
HierarchyCellDataOpsReal<TYPE>::swapData(
   const int data1_id,
   const int data2_id) const
{
#ifdef DEBUG_CHECK_ASSERTIONS
   std::shared_ptr<pdat::CellDataFactory<TYPE> > d1fact(
      SAMRAI_SHARED_PTR_CAST<pdat::CellDataFactory<TYPE>, hier::PatchDataFactory>(
         d_hierarchy->getPatchDescriptor()->getPatchDataFactory(data1_id)));
   TBOX_ASSERT(d1fact);
   std::shared_ptr<pdat::CellDataFactory<TYPE> > d2fact(
      SAMRAI_SHARED_PTR_CAST<pdat::CellDataFactory<TYPE>, hier::PatchDataFactory>(
...
template<class TYPE>
void
HierarchyCellDataOpsReal<TYPE>::printData(
   const int data_id,
   std::ostream& s,
   const bool interior_only) const
{
...
template<class TYPE>
void
HierarchyCellDataOpsReal<TYPE>::setToScalar(
   const int data_id,
   const TYPE& alpha,
   const bool interior_only) const
{
...
template<class TYPE>
void
HierarchyCellDataOpsReal<TYPE>::scale(
   const int dst_id,
   const TYPE& alpha,
   const int src_id,
   const bool interior_only) const
...
template<class TYPE>
void
HierarchyCellDataOpsReal<TYPE>::addScalar(
   const int dst_id,
   const int src_id,
   const TYPE& alpha,
   const bool interior_only) const
...
template<class TYPE>
void
HierarchyCellDataOpsReal<TYPE>::add(
   const int dst_id,
   const int src1_id,
   const int src2_id,
   const bool interior_only) const
   ...
   for (int ln = d_coarsest_level; ln <= d_finest_level; ++ln) {
      ...
      for (hier::PatchLevel::iterator ip(level->begin());
         ...
         std::shared_ptr<pdat::CellData<TYPE> > dst(
            SAMRAI_SHARED_PTR_CAST<pdat::CellData<TYPE>, hier::PatchData>(
               p->getPatchData(dst_id)));
         std::shared_ptr<pdat::CellData<TYPE> > src1(
            SAMRAI_SHARED_PTR_CAST<pdat::CellData<TYPE>, hier::PatchData>(
               p->getPatchData(src1_id)));
         std::shared_ptr<pdat::CellData<TYPE> > src2(
            SAMRAI_SHARED_PTR_CAST<pdat::CellData<TYPE>, hier::PatchData>(
...
template<class TYPE>
void
HierarchyCellDataOpsReal<TYPE>::subtract(
   const int dst_id,
   const int src1_id,
   const int src2_id,
   const bool interior_only) const
...
template<class TYPE>
void
HierarchyCellDataOpsReal<TYPE>::multiply(
   const int dst_id,
   const int src1_id,
   const int src2_id,
   const bool interior_only) const
...
template<class TYPE>
void
HierarchyCellDataOpsReal<TYPE>::divide(
   const int dst_id,
   const int src1_id,
   const int src2_id,
   const bool interior_only) const
...
template<class TYPE>
void
HierarchyCellDataOpsReal<TYPE>::reciprocal(
   const int dst_id,
   const int src_id,
   const bool interior_only) const
{
...
template<class TYPE>
void
HierarchyCellDataOpsReal<TYPE>::linearSum(
   const int dst_id,
   const TYPE& alpha,
   const int src1_id,
   const TYPE& beta,
...
template<class TYPE>
void
HierarchyCellDataOpsReal<TYPE>::axpy(
   const int dst_id,
   const TYPE& alpha,
   const int src1_id,
   const int src2_id,
...
template<class TYPE>
void
HierarchyCellDataOpsReal<TYPE>::axmy(
   const int dst_id,
   const TYPE& alpha,
   const int src1_id,
   const int src2_id,
...
template<class TYPE>
void
HierarchyCellDataOpsReal<TYPE>::abs(
   const int dst_id,
   const int src_id,
   const bool interior_only) const
{
...
template<class TYPE>
void
HierarchyCellDataOpsReal<TYPE>::setRandomValues(
   const int data_id,
   const TYPE& width,
   const TYPE& low,
   const bool interior_only) const
{
   ...
   for (int ln = d_coarsest_level; ln <= d_finest_level; ++ln) {
      ...
      for (hier::PatchLevel::iterator ip(level->begin());
         ...
         std::shared_ptr<pdat::CellData<TYPE> > data(
            SAMRAI_SHARED_PTR_CAST<pdat::CellData<TYPE>, hier::PatchData>(
               p->getPatchData(data_id)));
...
template<class TYPE>
size_t
HierarchyCellDataOpsReal<TYPE>::numberOfEntries(
   const int data_id,
   const bool interior_only) const
{
   TBOX_ASSERT(d_hierarchy);
...
template<class TYPE>
double
HierarchyCellDataOpsReal<TYPE>::sumControlVolumes(
   const int data_id,
...
template<class TYPE>
double
HierarchyCellDataOpsReal<TYPE>::L1Norm(
   const int data_id,
   const int vol_id,
...
template<class TYPE>
double
HierarchyCellDataOpsReal<TYPE>::L2Norm(
   const int data_id,
   const int vol_id,
   bool local_only) const
{
...
template<class TYPE>
double
HierarchyCellDataOpsReal<TYPE>::weightedL2Norm(
   const int data_id,
   const int wgt_id,
   const int vol_id) const
{
   ...
   for (int ln = d_coarsest_level; ln <= d_finest_level; ++ln) {
      ...
      for (hier::PatchLevel::iterator ip(level->begin());
         ...
         std::shared_ptr<pdat::CellData<TYPE> > data(
            SAMRAI_SHARED_PTR_CAST<pdat::CellData<TYPE>, hier::PatchData>(
               p->getPatchData(data_id)));
         std::shared_ptr<pdat::CellData<TYPE> > weight(
            SAMRAI_SHARED_PTR_CAST<pdat::CellData<TYPE>, hier::PatchData>(
...
template<class TYPE>
double
HierarchyCellDataOpsReal<TYPE>::RMSNorm(
   const int data_id,
   const int vol_id) const
{
...
template<class TYPE>
double
HierarchyCellDataOpsReal<TYPE>::weightedRMSNorm(
   const int data_id,
   const int wgt_id,
   const int vol_id) const
{
...
template<class TYPE>
double
HierarchyCellDataOpsReal<TYPE>::maxNorm(
   const int data_id,
   const int vol_id,
   bool local_only) const
{
...
template<class TYPE>
TYPE
HierarchyCellDataOpsReal<TYPE>::dot(
   const int data1_id,
   const int data2_id,
   const int vol_id,
   bool local_only) const
{
   ...
   for (int ln = d_coarsest_level; ln <= d_finest_level; ++ln) {
      ...
      for (hier::PatchLevel::iterator ip(level->begin());
         ...
         std::shared_ptr<pdat::CellData<TYPE> > data1(
            SAMRAI_SHARED_PTR_CAST<pdat::CellData<TYPE>, hier::PatchData>(
               p->getPatchData(data1_id)));
         std::shared_ptr<pdat::CellData<TYPE> > data2(
            SAMRAI_SHARED_PTR_CAST<pdat::CellData<TYPE>, hier::PatchData>(
...
template<class TYPE>
TYPE
HierarchyCellDataOpsReal<TYPE>::integral(
   const int data_id,
   const int vol_id) const
{
   TBOX_ASSERT(d_hierarchy);
...
template<class TYPE>
int
HierarchyCellDataOpsReal<TYPE>::computeConstrProdPos(
   const int data1_id,
   const int data2_id,
   const int vol_id) const
{
...
template<class TYPE>
void
HierarchyCellDataOpsReal<TYPE>::compareToScalar(
   const int dst_id,
   const int src_id,
   const TYPE& alpha,
   const int vol_id) const
...
template<class TYPE>
int
HierarchyCellDataOpsReal<TYPE>::testReciprocal(
   const int dst_id,
   const int src_id,
   const int vol_id) const
{
...
template<class TYPE>
TYPE
HierarchyCellDataOpsReal<TYPE>::maxPointwiseDivide(
   const int numer_id,
   const int denom_id,
   bool local_only) const
{
   ...
   for (int ln = d_coarsest_level; ln <= d_finest_level; ++ln) {
      ...
      for (hier::PatchLevel::iterator ip(level->begin());
         ...
         std::shared_ptr<pdat::CellData<TYPE> > numer(
            SAMRAI_SHARED_PTR_CAST<pdat::CellData<TYPE>, hier::PatchData>(
               p->getPatchData(numer_id)));
         std::shared_ptr<pdat::CellData<TYPE> > denom(
            SAMRAI_SHARED_PTR_CAST<pdat::CellData<TYPE>, hier::PatchData>(
...
template<class TYPE>
TYPE
HierarchyCellDataOpsReal<TYPE>::minPointwiseDivide(
   const int numer_id,
   const int denom_id,
   bool local_only) const
{
...
template<class TYPE>
TYPE
HierarchyCellDataOpsReal<TYPE>::min(
   const int data_id,
   const bool interior_only) const
{
   TBOX_ASSERT(d_hierarchy);
...
template<class TYPE>
TYPE
HierarchyCellDataOpsReal<TYPE>::max(
   const int data_id,
   const bool interior_only) const
{
   TBOX_ASSERT(d_hierarchy);
