...
int
SideIntegerConstantRefine::getOperatorPriority() const
{
   return 0;
}

hier::IntVector
SideIntegerConstantRefine::getStencilWidth(const tbox::Dimension& dim) const
{
   return hier::IntVector::getZero(dim);
}

void
SideIntegerConstantRefine::refine(
   hier::Patch& fine,
