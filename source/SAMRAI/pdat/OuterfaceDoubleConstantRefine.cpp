...
// in conrefine1d.f:
void SAMRAI_F77_FUNC(conrefoutfacedoub1d, CONREFOUTFACEDOUB1D) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
   ...
   const double *, double *);
// in conrefine2d.f:
void SAMRAI_F77_FUNC(conrefoutfacedoub2d0, CONREFOUTFACEDOUB2D0) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
   ...
   const int *,
   const double *, double *);
void SAMRAI_F77_FUNC(conrefoutfacedoub2d1, CONREFOUTFACEDOUB2D1) (const int&,
   const int&,
   const int&, const int&,
   const int&, const int&,
   const int&, const int&,
   ...
   const double *, double *);
// in conrefine3d.f:
void SAMRAI_F77_FUNC(conrefoutfacedoub3d0, CONREFOUTFACEDOUB3D0) (const int&,
   const int&, const int&,
   ...
   const int *,
   const double *, double *);
void SAMRAI_F77_FUNC(conrefoutfacedoub3d1, CONREFOUTFACEDOUB3D1) (const int&,
   const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   ...
   const int *,
   const double *, double *);
void SAMRAI_F77_FUNC(conrefoutfacedoub3d2, CONREFOUTFACEDOUB3D2) (const int&,
   const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
   const int&, const int&, const int&,
...
int
OuterfaceDoubleConstantRefine::getOperatorPriority() const
{
   return 0;
}
...
void
OuterfaceDoubleConstantRefine::refine(
   hier::Patch& fine,
   ...
   const hier::IntVector& ratio) const
{
   ...
   std::shared_ptr<OuterfaceData<double> > cdata(
      SAMRAI_SHARED_PTR_CAST<OuterfaceData<double>, hier::PatchData>(
         coarse.getPatchData(src_component)));
   std::shared_ptr<OuterfaceData<double> > fdata(
      SAMRAI_SHARED_PTR_CAST<OuterfaceData<double>, hier::PatchData>(
         ...
         for (int d = 0; d < fdata->getDepth(); ++d) {
            ...
            for (int i = 0; i < 2; ++i) {
               if (dim == tbox::Dimension(1)) {
                  SAMRAI_F77_FUNC(conrefoutfacedoub1d, CONREFOUTFACEDOUB1D) (
                     ifirstc(0), ilastc(0),
                     ifirstf(0), ilastf(0),
                     cilo(0), cihi(0),
                     filo(0), fihi(0),
                  ...
                  if (axis == 0) {
                     SAMRAI_F77_FUNC(conrefoutfacedoub2d0, CONREFOUTFACEDOUB2D0) (
                     ...
                     SAMRAI_F77_FUNC(conrefoutfacedoub2d1, CONREFOUTFACEDOUB2D1) (
                        ifirstc(0), ifirstc(1), ilastc(0), ilastc(1),
                        ifirstf(0), ifirstf(1), ilastf(0), ilastf(1),
                        cilo(0), cilo(1), cihi(0), cihi(1),
                        filo(0), filo(1), fihi(0), fihi(1),
                  ...
                  if (axis == 0) {
                     SAMRAI_F77_FUNC(conrefoutfacedoub3d0, CONREFOUTFACEDOUB3D0) (
                     ...
                     SAMRAI_F77_FUNC(conrefoutfacedoub3d1, CONREFOUTFACEDOUB3D1) (
                        ifirstc(0), ifirstc(1), ifirstc(2),
                        ilastc(0), ilastc(1), ilastc(2),
                        ifirstf(0), ifirstf(1), ifirstf(2),
                        ilastf(0), ilastf(1), ilastf(2),
                     ...
                     SAMRAI_F77_FUNC(conrefoutfacedoub3d2, CONREFOUTFACEDOUB3D2) (
                        ifirstc(0), ifirstc(1), ifirstc(2),
                        ilastc(0), ilastc(1), ilastc(2),
                        ifirstf(0), ifirstf(1), ifirstf(2),
                        ilastf(0), ilastf(1), ilastf(2),
