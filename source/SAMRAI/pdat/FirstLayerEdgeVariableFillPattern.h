...
#ifndef included_pdat_FirstLayerEdgeVariableFillPattern
#define included_pdat_FirstLayerEdgeVariableFillPattern
...
/*!
 * @brief Class FirstLayerEdgeVariableFillPattern is a concrete
...
public:
    ...
    */
   explicit FirstLayerEdgeVariableFillPattern(
      const tbox::Dimension& dim);

   /*!
    * @brief Destructor
    */
   virtual ~FirstLayerEdgeVariableFillPattern();

   /*!
    * @brief Calculate overlaps between the destination and source geometries
    * according to the fill pattern.
    *
    * This will return the portion of the intersection of the edge geometries
    ...
    * boundary edges, which SAMRAI by convention considers to be part of the
    ...
    *
    * For this implementation, that space is the edge-centered intersection
    * between fill_boxes, (computed by the RefineSchedule), data_box, which
    * specifies the extent of the destination data, and the boundary edges
   ...
   /*!
    * @brief Returns a string name identifier "FIRST_LAYER_EDGE_FILL_PATTERN".
    */
   const std::string&
...
private:
    ...
    *
    * The computed BoxContainers will consist of edge-centered boxes
    * representing the edges on the boundary of the box.
    *
