   ...
   const double& bstate)
{
   ...
   if (btype == Bdry::FACE3D) {
      ...
      if (bcase == BdryCond::FLOW) {
         ...
         constval = bstate;
         dxfact = 0.0;
      } else if (bcase == BdryCond::NEUMANN) {
         valfact = 1.0;
         constval = 0.0;
      ...
      if (bcase == BdryCond::XFLOW || bcase == BdryCond::YFLOW ||
         ...
         constval = bstate;
         dxfact = 0.0;
      } else if (bcase == BdryCond::XNEUMANN || bcase == BdryCond::YNEUMANN ||
   ...
   if (btype == Bdry::FACE3D) {
      ...
      if (bcase == BdryCond::XFLOW || bcase == BdryCond::XREFLECT ||
         ...
         if (bloc == EdgeBdyLoc3D::XLO_ZLO || bloc == EdgeBdyLoc3D::XLO_ZHI ||
            ...
            offsign = -1;
         } else if (bloc == EdgeBdyLoc3D::XHI_ZLO ||
                    bloc == EdgeBdyLoc3D::XHI_ZHI ||
                    bloc == EdgeBdyLoc3D::XHI_YLO ||
                    bloc == EdgeBdyLoc3D::XHI_YHI) {
            offsign = 1;
         } else {
            bad_case = true;
         }
                 ...
                 bcase == BdryCond::YDIRICHLET ||
                 bcase == BdryCond::YNEUMANN) {
         idir = 1;
         if (bloc == EdgeBdyLoc3D::YLO_ZLO || bloc == EdgeBdyLoc3D::YLO_ZHI ||
             bloc == EdgeBdyLoc3D::XLO_YLO || bloc == EdgeBdyLoc3D::XHI_YLO) {
            offsign = -1;
         } else if (bloc == EdgeBdyLoc3D::YHI_ZLO ||
                    bloc == EdgeBdyLoc3D::YHI_ZHI ||
                    bloc == EdgeBdyLoc3D::XLO_YHI ||
                    bloc == EdgeBdyLoc3D::XHI_YHI) {
            offsign = 1;
         } else {
            bad_case = true;
         ...
         if (bloc == EdgeBdyLoc3D::YLO_ZLO || bloc == EdgeBdyLoc3D::YHI_ZLO ||
            ...
            offsign = -1;
         } else if (bloc == EdgeBdyLoc3D::YLO_ZHI ||
                    bloc == EdgeBdyLoc3D::YHI_ZHI ||
                    bloc == EdgeBdyLoc3D::XLO_ZHI ||
                    bloc == EdgeBdyLoc3D::XHI_ZHI) {
            offsign = 1;
         } else {
            bad_case = true;
      ...
      if (bcase == BdryCond::XFLOW || bcase == BdryCond::XREFLECT ||
          bcase == BdryCond::XDIRICHLET || bcase == BdryCond::XNEUMANN) {
         idir = 0;
         if (bloc == NodeBdyLoc3D::XLO_YLO_ZLO ||
             bloc == NodeBdyLoc3D::XLO_YHI_ZLO ||
             bloc == NodeBdyLoc3D::XLO_YLO_ZHI ||
             bloc == NodeBdyLoc3D::XLO_YHI_ZHI) {
            offsign = -1;
         } else {
            offsign = 1;
         }
         ...
         idir = 1;
         if (bloc == NodeBdyLoc3D::XLO_YLO_ZLO ||
             bloc == NodeBdyLoc3D::XHI_YLO_ZLO ||
             bloc == NodeBdyLoc3D::XLO_YLO_ZHI ||
             bloc == NodeBdyLoc3D::XHI_YLO_ZHI) {
            offsign = -1;
         } else {
            offsign = 1;
         }
...
CartesianBoundaryUtilities3::stuff3dBdryFortConst()
{
   SAMRAI_F77_FUNC(stufcartbdryloc3d, STUFCARTBDRYLOC3D) (BdryLoc::XLO, BdryLoc::XHI,
      ...
      NodeBdyLoc3D::XLO_YLO_ZLO, NodeBdyLoc3D::XHI_YLO_ZLO,
