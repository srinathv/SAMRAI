...
public:
    ...
    * @pre coarse.getPatchData(src_component) is actually a std::shared_ptr<pdat::FaceData<float> >
    * @pre fine.getPatchData(dst_component) is actually a std::shared_ptr<pdat::FaceData<float> >
