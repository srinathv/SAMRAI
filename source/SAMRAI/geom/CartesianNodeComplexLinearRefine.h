...
public:
    ...
    * @pre coarse.getPatchData(src_component) is actually a std::shared_ptr<pdat::NodeData<dcomplex> >
    * @pre fine.getPatchData(dst_component) is actually a std::shared_ptr<pdat::NodeData<dcomplex> >
