...
public:
    ...
    * @pre fine.getPatchData(src_component) is actually a std::shared_ptr<pdat::EdgeData<double> >
    * @pre coarse.getPatchData(dst_component) is actually a std::shared_ptr<pdat::EdgeData<double> >
